...
5.  [Breakpad](./Breakpad/breakpad.hpp)----------> Simple package of Google Breakpad;
6.  [Design pattern](./DesignPattern)----------> Some examples of design patterns;
...
7.  [Hawthorn](./Glog/main.cc)---------->Google Glog example;
8.  [Icmp](./Icmp/icmp.hpp)----------> Simple encapsulation of Linux ICMP protocol;
9.  [LinkedList](./LinkedList/linkedlist.hpp)----------> Linked list related operations, insert, remove, reverse, print;
10. [MonitoringDirectory](./MonitoringDirectory/monitoring_directory.hpp)---------->Simple encapsulation of file changes in the Windows monitoring directory;
11. [Mutex](./Mutex/mutex.hpp)----------> Simple mutex and spin lock implemented using std::atomic_flag;
12. [Server](./Server)---------->Some examples of Linux Server;
